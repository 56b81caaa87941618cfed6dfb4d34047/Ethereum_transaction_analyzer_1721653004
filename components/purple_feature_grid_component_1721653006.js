...
Vue.component("purple_feature_grid_component_1721653006", {
    template: `
    <!-- Features list -->
    <div id="features-grid" class="grid md:grid-cols-3 gap-8 md:gap-12 bg-white p-5">
        ...
        <div id="feature-1">
            ...
            <div class="flex" id="feature-1-description-container"><p id="feature-1-description" class="flex-1 text-sm">Stay ahead of the curve with our advanced Ethereum transaction analysis tool. Gain real-time insights into new transactions as they occur on the blockchain.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-2">
            ...
            <div class="flex" id="feature-2-description-container"><p id="feature-2-description" class="flex-1 text-sm">Unlock a wealth of information with our comprehensive transaction analysis. Explore details like gas costs, contract interactions, and more for a deep understanding of each transaction.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container"><h4 id="feature-3-title" class="flex-1 text-slate-50 font-medium">Automated Alerts and Notifications</h4></div>
            </div>
            <div class="flex" id="feature-3-description-container"><p id="feature-3-description" class="flex-1 text-sm">Never miss a beat with our customizable alert system. Set up notifications for specific transaction types, addresses, or values to stay informed at all times.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-4">
            ...
            <div class="flex" id="feature-4-description-container"><p id="feature-4-description" class="flex-1 text-sm">Navigate our intuitive interface with ease. Our clean and modern design ensures a seamless experience, allowing you to focus on analyzing transactions without any distractions.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container"><h4 id="feature-5-title" class="flex-1 text-slate-50 font-medium">Robust Security Measures</h4></div>
            </div>
            <div class="flex" id="feature-5-description-container"><p id="feature-5-description" class="flex-1 text-sm">Trust that your data is in safe hands. We implement industry-leading security protocols to protect your privacy and ensure the integrity of your transaction analysis.</p></div>
        </div>
        <!-- Feature -->
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container"><h4 id="feature-6-title" class="flex-1 text-slate-50 font-medium">Integration with Popular Tools</h4></div>
            </div>
            <div class="flex" id="feature-6-description-container"><p id="feature-6-description" class="flex-1 text-sm">Seamlessly integrate our transaction analysis tool with your existing workflow. We offer compatibility with popular Ethereum wallets, explorers, and development environments.</p></div>
        </div>
    </div>`,
        data() {
            return {
